            ...
            <main className="content page__content">
              ...
              адаптироваться и полноценно участвовать в жизни общества.</p>
                ...
                которые поддерживают дружбу между ребенком и наставником.</p>
                                <a href='https://www.nastavniki.org/campaign/pomoch-dengami/' target='_blank' rel='noreferrer' className="about__action">сделать пожертвование</a>
                            </div>
                        </div>
                        <div className="about__column">
                            <h3 className="about__column-header background-orange">Наставничество</h3>
                            <div className="about__text">
                ...
                счастливое и успешное будущее.</p>
                                <a href='https://www.nastavniki.org/volontyorstvo/kak-stat-volonterom/' target='_blank' rel='noreferrer'  className="about__action">подробнее</a>
                            </div>
                        </div>
                        <div className="about__column ">
                ...
                помощь, корпоративное волонтерство, мастер-классы, лекции, учебные программы</p>
                                <a href='https://www.nastavniki.org/oficzialno/nashi-partneryi/moskva-5/' target='_blank' rel='noreferrer'  className="about__action">подробнее</a>
                            </div>
                        </div>
                    </div>
                </section>
